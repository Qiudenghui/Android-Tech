...
public class PatchClass {
    ...
    public static void process(String buildDir, String lib) {
        ...
        constructor.insertBefore("System.out.println(com.devilwwj.wwjdex.AntilazyLoad.class);")
        ...
        constructor1.insertBefore("System.out.println(com.devilwwj.wwjdex.AntilazyLoad.class);")
